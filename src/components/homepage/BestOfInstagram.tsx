...
export const BestOfInstagram: React.FC<BestOfInstagramProps> = ({ initialConfig }) => {
  ...
  return (
    <section
      ...
      className="py-14 sm:py-16 bg-[#FAF7F2] border-t border-[#E5D2BC]/20"
    >
      <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="text-center max-w-2xl mx-auto">
            <div className="flex items-center justify-center gap-2">
              ...
              <a
                ...
                className="text-xs font-sans font-semibold text-[#2A211C]/75 hover:text-[#B08D57] transition-colors flex items-center gap-1"
          ...
          {activeItems.map((item) => {
            return (
              <div
                ...
                className="w-[280px] sm:w-[320px] lg:w-auto shrink-0 snap-start bg-white rounded-lg border border-[#E5D2BC]/30 overflow-hidden shadow-xs hover:shadow-md hover:border-[#B08D57]/40 transition-all duration-300 flex flex-col justify-between cursor-pointer group"
              >
                {/* 1. Curated Social Header (Factually Accurate) */}
                <div className="p-3.5 flex items-center justify-between border-b border-[#E5D2BC]/15 bg-[#FAF7F2]/60">
                  <div className="flex items-center gap-2.5">
                    {/* Brand Avatar */}
                    <div className="w-8 h-8 rounded-full bg-[#2A211C] text-[#FAF7F2] font-serif font-bold text-xs flex items-center justify-center border border-[#E5D2BC]/40 shadow-xs">
                      K
                    </div>
                    <div className="flex flex-col">
                      <span className="font-sans font-bold text-xs text-[#2A211C] tracking-tight">
                        _saandsha
                      </span>
                  ...
                  <Instagram className="w-4 h-4 text-stone-400 group-hover:text-[#B08D57] transition-colors" />
                </div>
        ...
        <div className="mt-8 sm:mt-10 flex justify-center">
          <a
            ...
            className="px-8 py-3 rounded border border-[#2A211C] text-[#2A211C] hover:bg-[#2A211C] hover:text-[#FAF7F2] font-sans text-xs font-bold tracking-widest uppercase transition-all duration-300 flex items-center gap-2 cursor-pointer shadow-xs"
          >
            <Instagram className="w-3.5 h-3.5" />
