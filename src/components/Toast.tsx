    ...
    <AnimatePresence>
      {toast?.visible && (
        <motion.div
          ...
          id="toast-alert"
          className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[100] flex items-center gap-3 bg-[#2A211C] text-[#FBF6EE] px-5 py-3.5 rounded-lg shadow-xl border border-[#E5D2BC]/20 max-w-md w-[calc(100vw-2rem)]"
        >
