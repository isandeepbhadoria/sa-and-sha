...
export const TermsConditionsPage: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 md:px-6 py-10 md:py-16 space-y-10 text-[#2A211C]" id="terms-conditions-page">
      ...
      <nav aria-label="Breadcrumb" className="text-xs font-sans text-stone-500 flex items-center gap-2">
        ...
        <span className="text-[#2A211C] font-medium">Terms & Conditions</span>
      </nav>
      ...
      <div className="text-center space-y-3 border-b border-[#E5D2BC]/30 pb-8">
        <span className="text-xs font-sans font-bold tracking-[0.25em] text-[#B08D57] uppercase flex items-center justify-center gap-1.5">
          <Scale className="w-4 h-4 text-[#B08D57]" /> Legal Framework & Agreement
        </span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4" id="terms-highlights-grid">
        ...
        <div className="bg-white p-4 rounded-lg border border-[#E5D2BC]/30 shadow-sm space-y-1.5">
          <div className="flex items-center gap-2 text-[#C98A82]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 hidden lg:block">
          <div className="sticky top-36 bg-white/80 p-4 rounded-lg border border-[#E5D2BC]/30 space-y-3">
            <div className="text-xs font-sans font-bold uppercase tracking-wider text-[#2A211C] border-b border-[#E5D2BC]/20 pb-2 flex items-center gap-1.5">
              <FileText className="w-3.5 h-3.5 text-[#B08D57]" /> Key Index
            </div>
            <nav className="space-y-1 text-xs font-sans">
              {[
                ...
                <button
                  ...
                  className="w-full text-left px-2 py-1.5 rounded transition-colors text-stone-600 hover:text-[#B08D57] hover:bg-[#FBF6EE]"
                >
                  {item.label}
                </button>
              ))}
        ...
        <div className="lg:col-span-3 space-y-10 text-xs md:text-sm font-sans leading-relaxed text-stone-800">
          ...
          {/* SECTION 1 */}
          <section id="sec-terms-acceptance" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
              <Scale className="w-5 h-5 text-[#B08D57]" />
              <h2 className="font-serif text-lg md:text-xl font-bold text-[#2A211C]">
          ...
          {/* SECTION 2 */}
          <section id="sec-terms-eligibility" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
            ...
            <p>
              Use of Sa and Sha is available only to persons who can form legally binding contracts under the <strong className="text-[#2A211C]">Indian Contract Act, 1872</strong>. Persons who are "incompetent to contract" within the meaning of the Indian Contract Act, 1872, including un-discharged insolvents, are not eligible to use the website.
            </p>
            <p>
          ...
          {/* SECTION 3 */}
          <section id="sec-terms-accounts" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
            ...
            <p>
              <strong className="text-[#2A211C]">Account Responsibility:</strong> You are responsible for maintaining the confidentiality of your mobile device, login access, and session activity. You agree to accept responsibility for all orders and activities that occur under your account.
            </p>
            <p>
          ...
          <section id="sec-terms-customer-auth" className="space-y-4 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
              <UserCheck className="w-5 h-5 text-[#B08D57]" />
              <h2 className="font-serif text-lg md:text-xl font-bold text-[#2A211C]">
            ...
            <p className="p-3 bg-stone-50 rounded border border-stone-200 text-stone-700">
              <strong className="text-[#2A211C]">Privacy & Scope Guarantee:</strong> Authenticating via Google Sign-In does <strong>NOT</strong> grant Sa and Sha access to your personal Google services (such as Gmail, Google Drive, Google Photos, Google Calendar, or Google Contacts). Google Sign-In is used solely for secure account sign-in and profile verification.
            </p>
          </section>

          {/* SECTION 4 */}
          <section id="sec-terms-products" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
            ...
            <p>
              <strong className="text-[#2A211C]">Color & Sizing Accuracy:</strong> We make every effort to display garment colors and fit dimensions as accurately as possible. However, actual colors may vary slightly due to device screen settings and studio lighting. Please consult our Garment Size Guide prior to ordering.
            </p>
          </section>

          {/* SECTION 5 */}
          <section id="sec-terms-pricing" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
            ...
            <p>
              All prices listed on Sa and Sha are in <strong className="text-[#2A211C]">Indian Rupees (INR, ₹)</strong> and are inclusive of applicable Goods and Services Tax (GST) under Indian law.
            </p>
            <div className="space-y-2">
              <div className="p-3 bg-stone-50 rounded border border-stone-200 space-y-1">
                <strong className="text-[#2A211C] font-bold block">B2B Tax Invoicing (GSTIN):</strong>
              ...
              <div className="p-3 bg-stone-50 rounded border border-stone-200 space-y-1">
                <strong className="text-[#2A211C] font-bold block">Price Corrections:</strong>
          ...
          {/* SECTION 6 */}
          <section id="sec-terms-payments" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
              <CreditCard className="w-5 h-5 text-[#B08D57]" />
              <h2 className="font-serif text-lg md:text-xl font-bold text-[#2A211C]">
          ...
          <section id="sec-terms-shipping" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            ...
            <p>
              Detailed shipping terms are published under our <Link to="/shipping-delivery" className="text-[#B08D57] font-semibold hover:underline">Shipping & Delivery Policy</Link>. Key highlights include:
            </p>
          ...
          {/* SECTION 8 */}
          <section id="sec-terms-returns" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
          ...
          {/* SECTION 9 */}
          <section id="sec-terms-ip" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
          ...
          {/* SECTION 10 */}
          <section id="sec-terms-prohibited" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
              <Ban className="w-5 h-5 text-[#B08D57]" />
              <h2 className="font-serif text-lg md:text-xl font-bold text-[#2A211C]">
          ...
          {/* SECTION 11 */}
          <section id="sec-terms-reviews" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
          ...
          {/* SECTION 12 */}
          <section id="sec-terms-liability" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
          ...
          {/* SECTION 13 */}
          <section id="sec-terms-jurisdiction" className="space-y-4 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
              <Gavel className="w-5 h-5 text-[#B08D57]" />
              <h2 className="font-serif text-lg md:text-xl font-bold text-[#2A211C]">
            ...
            <div className="p-4 bg-[#F4E6D7]/20 rounded-lg border border-[#E5D2BC]/30 space-y-3 pt-4">
              <h3 className="font-serif font-bold text-sm text-[#2A211C] uppercase tracking-wider">
