...
export const PrivacyPolicyPage: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 md:px-6 py-10 md:py-16 space-y-10 text-[#2A211C]" id="privacy-policy-page">
      ...
      <nav aria-label="Breadcrumb" className="text-xs font-sans text-stone-500 flex items-center gap-2">
        ...
        <span className="text-[#2A211C] font-medium">Privacy Policy</span>
      </nav>
      ...
      <div className="text-center space-y-3 border-b border-[#E5D2BC]/30 pb-8">
        <span className="text-xs font-sans font-bold tracking-[0.25em] text-[#B08D57] uppercase flex items-center justify-center gap-1.5">
          <ShieldCheck className="w-4 h-4 text-[#B08D57]" /> Legal Compliance & Transparency
        </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 hidden lg:block">
          <div className="sticky top-36 bg-white/80 p-4 rounded-lg border border-[#E5D2BC]/30 space-y-3">
            <div className="text-xs font-sans font-bold uppercase tracking-wider text-[#2A211C] border-b border-[#E5D2BC]/20 pb-2 flex items-center gap-1.5">
              <FileText className="w-3.5 h-3.5 text-[#B08D57]" /> Table of Contents
            </div>
        ...
        <div className="lg:col-span-3 space-y-10 text-xs md:text-sm font-sans leading-relaxed text-stone-800">
          ...
          {/* SECTION 1 */}
          <section id="sec-intro" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
          ...
          {/* SECTION 2 */}
          <section id="sec-collect" className="space-y-4 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
            ...
            <div className="space-y-3 pt-2">
              <div className="p-3 bg-[#FBF6EE]/50 rounded border border-[#E5D2BC]/20 space-y-1">
                <h3 className="font-bold text-[#2A211C] flex items-center gap-1.5 text-xs uppercase tracking-wider">
                  <UserCheck className="w-4 h-4 text-[#B08D57]" /> A. Account & Profile Data
                </h3>
              ...
              <div className="p-3 bg-[#FBF6EE]/50 rounded border border-[#E5D2BC]/20 space-y-1">
                <h3 className="font-bold text-[#2A211C] flex items-center gap-1.5 text-xs uppercase tracking-wider">
                  <CreditCard className="w-4 h-4 text-[#B08D57]" /> D. Billing & Payment Records
                </h3>
                <p className="text-stone-700">
                  Billing address, Razorpay transaction IDs, payment method category (e.g. UPI, Credit Card, Netbanking, COD), payment status, and refund history. <strong className="text-[#2A211C]">Sa and Sha NEVER stores your credit card numbers, CVVs, UPI PINs, or netbanking passwords.</strong> All sensitive payment credentials are handled exclusively by PCI-DSS compliant payment gateways.
                </p>
              </div>

              <div className="p-3 bg-[#FBF6EE]/50 rounded border border-[#E5D2BC]/20 space-y-1">
                <h3 className="font-bold text-[#2A211C] flex items-center gap-1.5 text-xs uppercase tracking-wider">
                  <Server className="w-4 h-4 text-[#B08D57]" /> E. Device, Environment & Security Logs
                </h3>
                <p className="text-stone-700">
              ...
              <div className="p-3 bg-[#FBF6EE]/50 rounded border border-[#E5D2BC]/20 space-y-1">
                <h3 className="font-bold text-[#2A211C] flex items-center gap-1.5 text-xs uppercase tracking-wider">
                  <Bell className="w-4 h-4 text-[#B08D57]" /> F. Communication Preferences
                </h3>
                <p className="text-stone-700">
          ...
          <section id="sec-google-signin" className="space-y-4 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
            ...
            <div className="p-4 bg-[#FBF6EE]/50 rounded-lg border border-[#E5D2BC]/25 space-y-3">
              <h3 className="font-bold text-[#2A211C] text-xs uppercase tracking-wider">
          ...
          {/* SECTION 3 */}
          <section id="sec-use" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-1">
              <div className="p-3 bg-stone-50 rounded border border-stone-200 space-y-1">
                <strong className="text-[#2A211C] block font-bold">1. Order Processing & Fulfillment</strong>
              ...
              <div className="p-3 bg-stone-50 rounded border border-stone-200 space-y-1">
                <strong className="text-[#2A211C] block font-bold">4. Security & Fraud Prevention</strong>
              ...
              <div className="p-3 bg-stone-50 rounded border border-stone-200 space-y-1">
                <strong className="text-[#2A211C] block font-bold">5. Customer Support & CRM</strong>
              ...
              <div className="p-3 bg-stone-50 rounded border border-stone-200 space-y-1">
                <strong className="text-[#2A211C] block font-bold">6. Legal & Tax Compliance</strong>
          ...
          {/* SECTION 4 */}
          <section id="sec-sharing" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
            ...
            <p>
              <strong className="text-[#2A211C]">Sa and Sha does NOT sell, rent, or trade your personal data to third-party advertisers.</strong> We share necessary data strictly with trusted service partners required to operate our platform:
            </p>
          ...
          {/* SECTION 5 */}
          <section id="sec-security" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
              <ShieldAlert className="w-5 h-5 text-[#B08D57]" />
              <h2 className="font-serif text-lg md:text-xl font-bold text-[#2A211C]">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-[#C98A82] shrink-0 mt-0.5" />
                <span><strong>Customer Session Control:</strong> You can view all currently active device logins under <strong className="text-[#2A211C]">Customer Dashboard &gt; Security & Sessions</strong>, view device names and last active times, and click <em>"Revoke Session"</em> or <em>"Sign Out Other Devices"</em> to terminate unauthorized access instantly.</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-[#C98A82] shrink-0 mt-0.5" />
          ...
          {/* SECTION 6 */}
          <section id="sec-retention" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
              <Database className="w-5 h-5 text-[#B08D57]" />
              <h2 className="font-serif text-lg md:text-xl font-bold text-[#2A211C]">
          ...
          {/* SECTION 7 */}
          <section id="sec-rights" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
            ...
            <div className="space-y-2">
              <div className="p-3 bg-stone-50 rounded border border-stone-200">
                <strong className="text-[#2A211C] font-bold block">• Right to Access & Review:</strong>
              ...
              <div className="p-3 bg-stone-50 rounded border border-stone-200">
                <strong className="text-[#2A211C] font-bold block">• Right to Correction & Updating:</strong>
          ...
          {/* SECTION 8 */}
          <section id="sec-cookies" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
          ...
          {/* SECTION 9 */}
          <section id="sec-children" className="space-y-3 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
          ...
          {/* SECTION 10 */}
          <section id="sec-contact" className="space-y-4 bg-white p-6 rounded-lg border border-[#E5D2BC]/30 shadow-sm">
            <div className="flex items-center gap-2 border-b border-[#E5D2BC]/20 pb-3">
            ...
            <div className="p-4 bg-[#F4E6D7]/20 rounded-lg border border-[#E5D2BC]/30 space-y-3">
