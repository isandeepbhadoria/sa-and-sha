...
export const ContactSupportPage: React.FC = () => {
  useSEO({
    ...
    description: 'Get in touch with Sa and Sha customer support at sales@sa-and-sha.com for order tracking, size advice, and assistance.'
  });
