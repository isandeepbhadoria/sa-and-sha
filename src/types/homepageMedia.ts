...
export const DEFAULT_FALLBACK_HERO_SLIDES: HeroSlide[] = [
  {
    ...
    altText: "Tailored Linen Shirts Crafted from European Flax",
    heading: "Summer Solace in Pure Linen",
    subheading: "Artisanal Craftsmanship",
  ...
  },
  {
    ...
    altText: "Breathable Everyday Linen Trousers and Layering",
    heading: "Effortless Drapery & Comfort",
    subheading: "100% Certified European Flax",
