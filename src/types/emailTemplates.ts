...
export const DEFAULT_EMAIL_VARIABLES: EmailTemplateVariable[] = [
  ...
  { name: 'tracking_url', label: 'Live Tracking URL', example: 'https://sa-and-sha.com/track/SS-100452', category: 'shipping' },
  ...
  { name: 'support_email', label: 'Customer Support Email', example: 'sales@sa-and-sha.com', category: 'company' },
...
export const MOCK_TEST_VARIABLES: Record<string, string> = {
  ...
  tracking_url: 'https://sa-and-sha.com/track/SS-100452',
