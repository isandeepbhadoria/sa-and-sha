...
export const DEFAULT_EMAIL_VARIABLES: EmailTemplateVariable[] = [
  ...
  { name: 'order_id', label: 'Order Reference ID', example: 'KL-100452', category: 'order' },
  ...
  { name: 'tracking_url', label: 'Live Tracking URL', example: 'https://saandsha.com/track/KL-100452', category: 'shipping' },
