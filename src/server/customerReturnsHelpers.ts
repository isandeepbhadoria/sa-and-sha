...
export async function getCustomerReturnRequestById(
  ...
  const matchEmail = cleanUserEmail && cleanUserEmail !== "sales@sa-and-sha.com" && cleanReturnEmail && cleanUserEmail === cleanReturnEmail;
...
export async function validateOrderReturnEligibility(
  ...
  const matchEmail = cleanUserEmail && cleanUserEmail !== "sales@sa-and-sha.com" && cleanOrderEmail === cleanOrderEmail;
...
export async function getCustomerCreditNote(
  ...
  if (!cnDoc) {
    ...
    if (cnDoc) {
      ...
      const matchEmail = cleanUserEmail && cleanUserEmail !== "sales@sa-and-sha.com" && cnEmail === cleanUserEmail;
